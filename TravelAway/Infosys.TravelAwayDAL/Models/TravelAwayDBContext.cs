...
namespace Infosys.TravelAwayDAL.Models
{
    public partial class TravelAwayDBContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            var connectionString = config.GetConnectionString("TravelAwayConnectionString");
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<BookPackage>(entity =>
            {
                ...
                entity.HasIndex(e => e.ContactNumber)
                    .HasName("UQ__BookPack__570665C610FA5A04")
                    .IsUnique();
            ...
            modelBuilder.Entity<Package>(entity =>
            {
                entity.HasIndex(e => e.PackageName)
                    .HasName("UQ__Package__73856F7A7E49A726")
                    .IsUnique();
            ...
            modelBuilder.Entity<PackageCategory>(entity =>
            {
                entity.HasIndex(e => e.PackageCategoryName)
                    .HasName("UQ__PackageC__DD8EB4748C86D07D")
                    .IsUnique();
            ...
            modelBuilder.Entity<PackageDetails>(entity =>
            {
                ...
                entity.Property(e => e.PlcesToVisit)
                    .IsRequired()
                    .HasMaxLength(500)
                    .IsUnicode(false);
